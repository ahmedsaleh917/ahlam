/**
 * 🕋 Service Worker لتطبيق "صفاء الروح - مفسر الأحلام"
 * استراتيجية: Cache-First للأصول الثابتة، Network-First للـ API
 */

const CACHE_NAME = 'safaa-dreams-v2.0';
const STATIC_ASSETS = [
    '/',
    '/index.html',
    '/manifest.json',
        ...
        caches.open(CACHE_NAME)
            .then((cache) => {
                ...
                return cache.addAll(STATIC_ASSETS.filter(url => 
                    !url.includes('font-awesome') && !url.includes('fonts.googleapis')
                ));
            })
...
console.log('🕋 Service Worker لـ "صفاء الروح - مفسر الأحلام" جاهز');
